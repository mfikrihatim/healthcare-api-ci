...
class article extends RestController
{
    ...
    public function index_get()
    {
        ...
        if (isset($_GET['id'])) {
            $query = $this->MSudi->GetDataWhere('article', 'id', $_GET['id'])->result();
            $this->response([
                'status' => 200,
                'message' => 'success',
                'data' => $query
            ...
            $query = $this->MSudi->GetData('article');
            $this->response([
                'status' => 200,
                'message' => 'success',
                'data' => $query
        ...
        if (isset($_POST['id'])) {
            ...
            if (isset($header['Authorization'])) {
                if ($header['Authorization'] == $this->token) {
                    ...
                    $query = $this->MSudi->AddData('article', $insert);
                    $this->response([
                        'status' => 200,
                        'message' => 'success',
                        'data' => $query
    ...
    public function update()
    {
        ...
        if (isset($header['Authorization'])) {
            if ($header['Authorization'] == $this->token) {
                ...
                $query = $this->MSudi->UpdateData('article', 'id', $update['id'], $update);
                $this->response([
                    'status' => 200,
                    'message' => 'success',
                    'data' => $query
    ...
    public function index_delete()
    {
        ...
        if (isset($header['Authorization'])) {
            if ($header['Authorization'] == $this->token) {
                ...
                $query = $this->MSudi->DeleteData('article', 'id', $delete['id'], $delete);
                $this->response([
                    'status' => 200,
                    'message' => 'success',
                    'data' => $query
